      ...
      <h1>
        <?php if ($search_result) : ?>
          ...
          <?php else : ?>
            ...
            لیست حسابات مشترکین دایمی
            (<?= ($total_rows)?($total_rows):(0); ?>)
        <?php endif; ?>
      </h1>
      <ol class="breadcrumb" style="direction:rtl;">
        <li><a href="#"><i class="fa fa-dashboard"></i> خانه</a></li>
        <li class="active">حسابات مشترکین دایمی</li>
      </ol>
    </section>
                  ...
                  <?php endif; ?>
                    <?php if ($search_result) : ?>
                      <table class="table direction table-striped table-bordered table-hover">
                          ...
                          <?php $perm_customer_finance_no = 1; foreach ($search_result as $search_result_item) : ?>
                              <tr>
                                  ...
                                  <td>
                                      <a href="<?= base_url(); ?>perm-customers-finances/<?= $search_result_item->id; ?>/delete" onclick="return confirmation();" class="btn btn-xs btn-block btn-flat bg-red"><i class="fa fa-trash"></i></a>
                                  </td>
                              </tr>
                          ...
                          <?php if ($perm_customer_finances) : ?>
                            <?php $perm_customer_finance_no = 1; foreach ($perm_customer_finances as $perm_customer_finance_item) : ?>
                                <tr>
                                    ...
                                    <td><?= $perm_customer_finance_item->full_name; ?></td>
                                    <td><?= $perm_customer_finance_item->phone; ?></td>
                                    <td>
                                    ...
                                    <td>
                                        <a href="#" class="btn btn-xs btn-block btn-flat bg-blue" data-toggle="modal" data-target="#edit_modal_<?= $perm_customer_finance_item->id; ?>"><i class="fa fa-list"></i></a>
                                    </td>
                                    <td>
                                        <a href="<?= base_url(); ?>perm-customers-finances/<?= $perm_customer_finance_item->id; ?>/delete" onclick="return confirmation();" class="btn btn-xs btn-block btn-flat bg-red"><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>

                                <!-- start edit modal -->
                                <div id="edit_modal_<?= $perm_customer_finance_item->id; ?>" class="modal fade" role="dialog">
                                  <div class="modal-dialog">
                                    <div class="modal-content">
                                      <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                                        <h4 class="modal-title">تصحیح <?= $perm_customer_finance_item->full_name; ?></h4>
                                      </div>
                                      <?= form_open(); ?>
                                        <div class="modal-body">
                                          <div class="row">
                                            <div class="col-md-4">
                                              <div class="form-group">
                                                <label>مبلغ</label>
                                                <input type="number" name="amount" class="form-control" value="<?= $perm_customer_finance_item->amount; ?>" required="">
                                              </div>
                                            </div>
                                            <div class="col-md-4">
                                              <div class="form-group">
                                                <label>نوعیت</label>
                                                <select name="category" class="select2" style="width:100% !important;">
                                                  <option value="creditor" <?php if ($perm_customer_finance_item->category=='creditor') { echo 'selected'; } ?>>رسید</option>
                                                  <option value="debtor" <?php if ($perm_customer_finance_item->category=='debtor') { echo 'selected'; } ?>>باقی</option>
                                                </select>
                                              </div>
                                            </div>
                                            <div class="col-md-4">
                                              <div class="form-group">
                                                <label>نمبر بل</label>
                                                <input type="number" name="bill_no" class="form-control" value="<?= $perm_customer_finance_item->bill_no; ?>">
                                              </div>
                                            </div>
                                          </div>
                                          <div class="form-group">
                                            <div class="row">
                                              <div class="col-md-4">
                                                ...
                                                <select name="date_d" class="select2" style="width:100% !important;">
                                                  <?php for ($day=1; $day<=31; $day++) { ?>
                                                    <option <?php if ($perm_customer_finance_item->date_d==$day) { echo 'selected'; } ?>><?= $day; ?></option>
                                                  <?php } ?>
                                                </select>
                                              </div>
                                              <div class="col-md-4">
                                                <label>ماه</label>
                                                <select name="date_m" class="select2" style="width:100% !important;">
                                                  <option <?php if ($perm_customer_finance_item->date_m=='1') { echo 'selected'; } ?> value="1">حمل - 1</option>
                                                  <option <?php if ($perm_customer_finance_item->date_m=='2') { echo 'selected'; } ?> value="2">ثور - 2</option>
                                                  <option <?php if ($perm_customer_finance_item->date_m=='3') { echo 'selected'; } ?> value="3">جوزا - 3</option>
                                                  <option <?php if ($perm_customer_finance_item->date_m=='4') { echo 'selected'; } ?> value="4">سرطان - 4</option>
                                                  <option <?php if ($perm_customer_finance_item->date_m=='5') { echo 'selected'; } ?> value="5">اسد - 5</option>
                                                  <option <?php if ($perm_customer_finance_item->date_m=='6') { echo 'selected'; } ?> value="6">سنبله - 6</option>
                                                  <option <?php if ($perm_customer_finance_item->date_m=='7') { echo 'selected'; } ?> value="7">میزان - 7</option>
                                                  <option <?php if ($perm_customer_finance_item->date_m=='8') { echo 'selected'; } ?> value="8">عقرب - 8</option>
                                                  <option <?php if ($perm_customer_finance_item->date_m=='9') { echo 'selected'; } ?> value="9">قوس - 9</option>
                                                  <option <?php if ($perm_customer_finance_item->date_m=='10') { echo 'selected'; } ?> value="10">جدی - 10</option>
                                                  <option <?php if ($perm_customer_finance_item->date_m=='11') { echo 'selected'; } ?> value="11">دلو - 11</option>
                                                  <option <?php if ($perm_customer_finance_item->date_m=='12') { echo 'selected'; } ?> value="12">حوت - 12</option>
                                                </select>
                                              </div>
                                              <div class="col-md-4">
                                                <label>سال</label>
                                                <select name="date_y" class="select2" style="width:100% !important;">
                                                  <?php for ($year=1395; $year<=1410; $year++) { ?>
                                                    <option <?php if ($perm_customer_finance_item->date_y==$year) { echo 'selected'; } ?>><?= $year; ?></option>
                                                  <?php } ?>
                                                </select>
                                              </div>
                                            </div>
                                          ...
                                          <div class="form-group">
                                            <label>تفصیل</label>
                                            <textarea class="form-control" rows="4" name="description"><?= $perm_customer_finance_item->description; ?></textarea>
                                          </div>
                                          <input type="hidden" name="id" value="<?= $perm_customer_finance_item->id; ?>">
                                          <input type="hidden" name="form_code" value="edit">
                                        </div>
                                        <div class="modal-footer">
                                          <button class="btn btn-primary btn-flat bg-blue">ذخیره <i class="fa fa-check"></i></button>
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">
          درج حساب مشترکین دایمی
        </h4>
      </div>
      <?= form_open(); ?>
        <div class="modal-body">
          <?php if ($perm_customers) : ?>
            <div class="form-group">
              <label>نام</label>

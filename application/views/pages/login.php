...
<div class="login-box">
  <div class="login-logo">
    <a href="<?= base_url(); ?>"><?= $settings->store_name; ?></a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body <?php if ($this->session->flashdata('danger')) { echo 'animated shake'; } ?>">
    <p class="login-box-msg">برای ورود فرم زیر را پر نمایید</p>
      ...
      <div class="row">
        <div class="col-xs-8">
          <div class="checkbox icheck">
            <label>
              <input type="checkbox" name="remember_me" value="remember"> مرا بخاطر داشته باش
            </label>
          </div>
        </div>
        <!-- /.col -->
